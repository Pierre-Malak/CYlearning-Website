...
<body>
  <header>
    ...
    <div class="navitems">
      ...
      <a href="viewsurvay.php"><p class="nbitems">Check Surveys&nbsp;&nbsp;<img class="icons" src="messenger.png"></p></a>
      <a href="chatpage.php"><p class="nbitems">View Chats&nbsp;&nbsp;<img class="icons" src="messenger.png"></p></a>
