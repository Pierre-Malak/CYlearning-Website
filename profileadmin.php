...
<body>
  <header>
    ...
    <div class="navitems">
      ...
      <a href="MainShowPenalty.php"><p class="nbitems"> Recived Penalties &nbsp;&nbsp; <img class="icons" src="penalty.png"></p></a>
      
      <a href="Mainadmin.php"><p class="nbitems"> ADD/Remove Admin&nbsp;&nbsp; <img class="icons" src="add.png"></p></a>
      <a href="Add courses.php"><p class="nbitems">ADD Courses&nbsp;&nbsp;<img class="icons" src="course.png"></p></a>
      <a href="table.php"><p class="nbitems"> Update/Delete Courses&nbsp;&nbsp;<img class="icons" src="up.png"></p></a>
      <a href="viewstudents.php"><p class="nbitems">Chat&nbsp;&nbsp;<img class="icons" src="messenger.png"></p></a>
